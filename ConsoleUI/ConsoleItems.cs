...
namespace ConsoleUI
{
	static class ConsoleItems
	{
		...
		private static List<Clickable> _allClickableItems { get; set; } = new List<Clickable>();
		public static List<Clickable> AllClickableItems
		{
			get
			{
		...
		public static void MainLoop()
		{
			...
			if(Input.record.KeyEvent.wVirtualKeyCode == 9)
			{
				// Insert logic to select next item in list.
			}
		}
	}
}
